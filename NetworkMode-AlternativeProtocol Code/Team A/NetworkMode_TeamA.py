...
teams_letters = ['B', 'C', 'D']
teams_binary = ['01', '10', '11']
team_frequencies = [0x20, 0x30, 0x40]

packages_team_list = [[], [], []]
dir_to_files=["atob.txt", "atoc.txt", "atod.txt"]
compressed_files = ["", "", ""]
...
def arrange_packages_per_team(mss):
    ...
    if team_id  == '00' and checksum.checkcrc(mss[2:], crc) and not fully_received_packages[current_receiving_team]:
