...
teams_letters = ['A', 'C', 'D']
teams_binary = ['00', '10', '11']
team_frequencies = [0x10, 0x30, 0x40]

packages_team_list = [[], [], []]
dir_to_files=["btoa.txt", "btoc.txt", "btod.txt"]
compressed_files = ["", "", ""]
...
def arrange_packages_per_team(mss):
    ...
    if team_id  == '01' and checksum.checkcrc(mss[2:], crc) and not fully_received_packages[current_receiving_team]:
