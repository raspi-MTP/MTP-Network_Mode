...
teams_letters = ['A', 'B', 'C']
teams_binary = ['00', '01', '10']
team_frequencies = [0x10, 0x20, 0x30]

packages_team_list = [[], [], []]
dir_to_files=["dtoa.txt", "dtob.txt", "dtoc.txt"]
compressed_files = ["", "", ""]
...
def arrange_packages_per_team(mss):
    ...
    if team_id  == '11' and checksum.checkcrc(mss[2:], crc) and not fully_received_packages[current_receiving_team]:
